...
@section('conteudo')
    ...
    <form action="" method="post">
        ...
        <div class="form-group row mt-2">
            <div class="col col-2">
                <label for="numContrato" class="mb-2 mt-2">Número do Contrato <font color="red">*</font></label>
            ...
            <div class="row">
                <div class="form-group col col-8">
                    <label for="objeto" class="mb-2 mt-2">Objeto <font color="red">*</font></label>
            ...
            <div class="row">
                <div class="form-group col col-2">
                    <label for="valor" class="mb-2 mt-2">Valor do Contrato <font color="red">*</font></label>
                    <input class="form-control" name="valor" id="valor" placeholder="R$">
                </div>

                <div class="form-group col col-2">
                    <label for="vencimento" class="mb-2 mt-2">Vencimento do Contrato <font color="red">*</font></label>
